<template>
  <div id="admins-list">
    <data-table :data="adminList" @addClicked="add" @delClicked="delMany" @checkboxChange="checkAll" @searchChange="search" :editable="auths.adminUsers.edit">
...
import {get_admins,delete_admin} from 'network/admins'
export default {
  name:'AdminsList',
  data() {
    return {
