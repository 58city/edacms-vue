<template>
  <div id="install">
    ...
    <el-card v-loading="installing">
      ...
      <install-site-info v-if="currentStep==3" ref="siteInfoForm" @formBlur="getFormStatus" :themes="themes" :themeError="themeError" :showError="showError"></install-site-info>
...
<script>
  ...
  import {testDatabase,loadThemes,install} from 'network/install'
