...
module.exports = function (req, res, next) {
	...
	var columnPath = '/' + req.params.column + req.params[0];
	console.log('我是栏目页',req.params);
	// http://localhost:3000/series/china/lu-zhan-zhi-wang-5 ==> {'0':'/china/lu-zhan-zhi-wang-5',column:'series'}
	categoriesService.one({path: columnPath,type: 'column'}, function (err, category) {
